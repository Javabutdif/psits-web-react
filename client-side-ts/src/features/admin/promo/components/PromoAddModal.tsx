...
export const PromoAddModal = ({ onClose }: PromoAddModalProps) => {
  ...
  // Validates step 1 — name, type, discount, dates, quantity. Scope/Categories/
  // Merchandise all live on step 2 now, so they're validated in handleSubmit instead.
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              placeholder=" "
              className="peer h-10 rounded-xl border-[#eeeeee] bg-transparent px-3"
            />
            <label className="pointer-events-none absolute top-0 left-3 -translate-y-1/2 bg-white px-1 text-xs text-sky-500 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:text-xs peer-focus:text-sky-500">
              Enter Promo Name
            </label>
          </div>
