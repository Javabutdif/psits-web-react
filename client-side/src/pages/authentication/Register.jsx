...
function Register() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100 p-4">
      <div className="max-w-lg md:max-w-4xl space-y-10 w-full flex flex-col md:flex-row md:items-stretch items-center justify-center font-montserrat bg-white shadow-lg rounded-lg">
        <div className="flex md:flex-col md:justify-center md:items-center md:space-y-5 md:text-center md:border-0 bg-[#074873] text-white space-x-4 px-4 py-5 rounded-t rounded-b-2xl items-center">
          <img src={logo} alt="PSITS Logo" className="w-24 h-24" />
          <div className="border-white border-l-2 md:border-0 md:pl-0 pl-4">
            <h3 className="text-2xl font-bold uppercase">Register</h3>
            <p>Become a PSITS Member! Start your tech journey and build lasting connections.</p>
          </div>
        </div>
