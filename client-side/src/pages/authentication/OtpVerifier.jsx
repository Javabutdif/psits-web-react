...
const OTPVerifier = ({ email }) => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100 p-4 font-montserrat">
      <div className='max-w-lg space-y-10 w-full flex text-center flex-col items-center justify-center font-montserrat px-8 py-10 bg-white shadow-lg rounded-lg'>
        <div className='space-y-3'>
          <h3 className='text-2xl font-bold'>Verify your OTP code</h3>
          <p>An 6-digit code has been sent to 
