  ...
  const events = [ 
    {
      ...
      title: "Pre-CCS ",
      price: "₱500.00",
      imageUrl: "https://psitsimagestorage.s3.ap-southeast-2.amazonaws.com/merchandise/1736695664641_merch6.png",
    ...
    },
    {
      ...
      title: "UC Days",
      price: "₱800.00",
      imageUrl: "https://psitsimagestorage.s3.ap-southeast-2.amazonaws.com/merchandise/1736775497633_merch5.png",
      stock: 5, // Example stock count
    },
    {
      id: 4,
    ...
    },
    {
      ...
      title: "Valentine's Day",
      price: "₱1000.00",
      imageUrl: "https://psitsimagestorage.s3.ap-southeast-2.amazonaws.com/merchandise/1736696596377_merch3.png",
      stock: 5, // Example stock count
    },
    {
      id: 7,
...
{/*               
               <button className="w-full bg-[#002E48] hover:bg-[#013e61] text-white text-sm font-medium py-2 px-4 rounded-md cursor-pointer transition-colors duration-200 hover:scale-105 transition-transform duration-200" tabIndex="0">
                View
							...
							<FormButton
								styles={
									"w-full bg-[#002E48] hover:bg-[#013e61] text-white text-sm font-medium py-2 px-4 rounded-md cursor-pointer transition-colors duration-200 hover:scale-105 transition-transform duration-200"
								}
