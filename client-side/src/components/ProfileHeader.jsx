...
const ProfileHeader = ({ label }) => {
  return (
    <div className="z-10 top-2 fixed sm:w-header-sm">
      <div className="flex justify-between items-center gap-2  mx-auto bg-white p-4 sm:py-2 px-4  rounded-md shadow-sm">
