...
const NavbarLanding = () => {
  ...
  return (
    <header
      className={`fixed w-full z-50 py-4 text-white font-montserrat ${
        scrollPosition > 100 ? "backdrop-blur-md" : "bg-transparent"
      }`}
    >
      <div className="container px-2 mx-auto flex justify-between items-center">
        ...
        >
          ...
          <div
            className={`backdrop-blur-2xl bg-black nav-mask lg:hidden ${
              isMenuOpen ? "nav-mask-open" : ""
            }`}
          />

          {/* Navigation links */}
          <ul
            className={`flex flex-col text-4xl space-y-9 -mt-5 lg:mt-0 lg:text-lg justify-center min-h-screen items-center lg:min-h-0 lg:space-y-0 lg:items-start lg:flex-row space-y-6 lg:space-x-9 ${
